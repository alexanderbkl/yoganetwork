...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle(R.string.a_adir_post);
        ...
        if (isUpdateKey.equals("editPost")) {
            ...
            //add
            getSupportActionBar().setTitle(R.string.addpost);
    ...
    private void showMediaPickDialog() {
        ...
        String[] options = {getString(R.string.add_image), getString(R.string.add_video),
                getString(R.string.add_audio), getString(R.string.add_youtube)};
        //alert dialog
        AlertDialog.Builder builder = new AlertDialog.Builder(AddPostActivity.this);
        //set title
        builder.setTitle(R.string.addcontent);
        //set items to dialog
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (which == 0) {
                    Snackbar.make(imageIv, R.string.opening_image, Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                    showImagePickDialog();
                } else if (which == 1) {
                    Snackbar.make(imageIv, getString(R.string.opening_video), Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                    isVideo = true;
                    videoPickDialog();
                    ...
                    Snackbar.make(imageIv, getString(R.string.open_file_explorer), Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
                    chooseAud();
                } else if (which == 3) {
                    Snackbar.make(imageIv, getString(R.string.opening_youtube), Snackbar.LENGTH_LONG)
                            .setAction("Action", null).show();
            ...
            private void youtubeUrlDialog() {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AddPostActivity.this);
                //set title
                builder.setTitle(getString(R.string.add_youtube));
                ...
                button.setText(getString(R.string.a_adir_post));
                button.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        youtubeUrl = youtubeUrlEt.getText().toString();
                        if (youtubeUrl.isEmpty()) {
                            Snackbar.make(imageIv, getString(R.string.add_youtube), Snackbar.LENGTH_LONG)
                                    .setAction("Action", null).show();
                        } else {
                            Snackbar.make(imageIv, getString(R.string.success), Snackbar.LENGTH_LONG)
                                    .setAction("Action", null).show();
                            if(!youtubeUrl.equals("")){
                                thumbnail = extractYoutubeThumbnail(youtubeUrl);
                                Glide.with(AddPostActivity.this).load(thumbnail).into(imageIv);
    ...
    private void chooseAud() {
        ...
        startActivityForResult(Intent.createChooser(intent, getString(R.string.add_audio)), PICK_AUD_REQUEST);
    }
    ...
    private void videoPickDialog() {
        ...
        builder.setTitle(getString(R.string.pick_from))
