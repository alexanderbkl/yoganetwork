...
import com.amit.yoganet.DashboardActivity;
...
public class FirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNormalNotification(RemoteMessage remoteMessage) {
        ...
        if (notificationType.equals("LikeNotification")) {
            ...
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            pIntent = PendingIntent.getActivity(this, i, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_MUTABLE);
    ...
    private void sendOAndAboveNotification(RemoteMessage remoteMessage) throws IOException {
        ...
        if (notificationType.equals("LikeNotification")) {
            ...
            intent.putExtra("extra", "profileLikes");
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            //Create pending intent with FLAG_ONE_SHOT and FLAG_MUTABLE
            pIntent = PendingIntent.getActivity(this, i, intent, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_MUTABLE);
