...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.amit.yoganet.R.layout.activity_settings);

        setSupportActionBar(findViewById(com.amit.yoganet.R.id.toolbar));

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle(com.amit.yoganet.R.string.ajustes);
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);

        postSwitch = findViewById(com.amit.yoganet.R.id.postSwitch);
        ...
        Button deleteAcc = findViewById(com.amit.yoganet.R.id.deleteAcc);
    ...
    private void showDeleteAccountDialog() {
        ...
        builder.setTitle(com.amit.yoganet.R.string.eliminar);
        builder.setMessage("Estás seguro de que quieres eliminar tu cuenta?");
        //delete button
        builder.setPositiveButton(com.amit.yoganet.R.string.eliminar, new DialogInterface.OnClickListener() {
            @Override
        ...
        builder.setNegativeButton(com.amit.yoganet.R.string.no, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                //dismiss dialog
                dialog.dismiss();
    ...
    private void unsubscrubePostNotification() {
        ...
        FirebaseMessaging.getInstance().unsubscribeFromTopic(""+TOPIC_POST_NOTIFICATION)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        String msg = getString(com.amit.yoganet.R.string.nonotif);
