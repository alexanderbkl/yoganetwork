...
public class ChattingActivity extends AppCompatActivity implements AudioRecordView.RecordingListener, View.OnClickListener, AttachmentOptionsListener {
    ...
    private com.android.yoganetwork.ChatView.AudioRecordView audioRecordView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        audioRecordView = new com.android.yoganetwork.ChatView.AudioRecordView();
        ...
        recyclerViewMessages = containerView.findViewById(R.id.chat_recyclerView);
...
/*       blockIv.setOnClickListener(new View.OnClickListener() {
  ...
  /*     likeIv.setOnClickListener(new View.OnClickListener() {
        ...
        containerView.findViewById(R.id.profileIv).setOnClickListener(this);
        ...
        audioRecordView.getSendView().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(message)) {
                    //text empty
                    Toast.makeText(ChattingActivity.this, R.string.nosepuedeenviarmsg, Toast.LENGTH_SHORT).show();
                }
                else {
                    //text not empty
                    sendMessage(message);
    ...
    @Override
    public void onClick(com.android.yoganetwork.ChatView.AttachmentOption attachmentOption) {
