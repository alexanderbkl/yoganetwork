...
private FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(R.string.iniciarsesion);
        //enable back button
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("282019033878-phdn43i25bej8n1586qtsgr3n5vqfhpo.apps.googleusercontent.com")
                .requestEmail()
                .build();
...
//    in the onCreate() method, initialize the FirebaseAuth instance
        ...
        mLoginBtn.setOnClickListener(v -> {
           ...
           String password = mPasswordEt.getText().toString().trim();
            ...
            if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
               ...
               mEmailEt.setError(getString(R.string.emailinvalido));
    ...
    notHaveAccountTv.setOnClickListener(v -> {
       startActivity(new Intent(LoginActivity.this, RegisterActivity.class));
        ...
        pd.setMessage(getString(R.string.iniciandosesion));
    }

    private void showRecoverPasswordDialog() {
        //AlertDialog
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(R.string.recuperarcontra);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //user logged in, so start LoginActivity
                            startActivity(new Intent(LoginActivity.this, DashboardActivity.class));
                       finish();
                        } else {
                            // If sign in fails, display a message to the user.
                            Toast.makeText(LoginActivity.this, R.string.autentfallida,
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                          ...
                          //  updateUI(user);
                            ...
                            // If sign in fails, display a message to the user.
                            Toast.makeText(LoginActivity.this, R.string.iniciofallido, Toast.LENGTH_SHORT).show();
                          //  updateUI(null);
                        }
